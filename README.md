...
The 16 electrode ground truth image datasets are provided in (/codeFiles folder) __sample_data.mat__  as __ref__ (inhomogeneous) and __data__(homogeneous).

### 2. Identical reconstruction software
The reconstruction software runs on MATLAB and includes:

(/codeFiles folder) __eidors-v3.10-ng.zip__ and __2.FR_FOM_FORMAT.m__.
